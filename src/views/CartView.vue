...
import { formatName, getCookie } from '@/stores/helpers.js'
  ...
  <div class="flex justify-center">
    <div class="container m-5 gap-4">
      ...
      <div class="flex flex-col md:grid md:grid-cols-3 mx-4">
        <div class="gap-4 col-span-2">
          <div v-for="product in cartStore.cart" :key="product.id">
            <div class="custom flex items-center justify-between mb-4">
              ...
              <div class="p-5 cursor-pointer" @click="deleteCartProduct(product.id)">
        ...
        <div class="custom p-6 mb-4 md:ml-4 md:col-span-1">
          <div class="flex flex-col justify-between min-h-full">
            ...
            <div>
              ...
              <button class="btn btn-custom-primary btn-ghost px-12 my-4" @click="newOrder">Commander
              </button>
              <button class="btn btn-custom-secondary btn-ghost px-15" @click="clearCart">Vider le panier
              </button>
            </div>
          </div>
        </div>
